...
- [Benchmark plan and architecture](benchmark-plan.md) — workloads,
...
- [Baseline benchmark report](baseline-benchmark-report.md) — ordinary
  Release measurements and initial scaling observations.
- [Contention profiling report](contention-profiling-report.md) —
  direct queue, lock, wait, occupancy, worker, and callback evidence.
- [Queue-coordination optimization report](queue-coordination-optimization-report.md)
  — controlled signaling A/B experiment and rejection decision.
- [Performance Evaluation closure](performance-evaluation-summary.md) — accepted
...
- [Optimization results](../results/optimization/) — paired evidence, summary,
  and charts.
- [Reproduction helper](../scripts/reproduce_performance_evaluation.ps1) — build and validation
...
powershell.exe -NoProfile -ExecutionPolicy Bypass `
  -File .\scripts\reproduce_performance_evaluation.ps1
```
